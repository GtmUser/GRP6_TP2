 ...
 * @version 1.0
 *
 * Cette classe va rechercher les informations necessaire à l'affichage de le la page de modification des données clients dans la base de données
 */
public class MySQL_modif {
	
	private static Logger logger = Logger.getLogger(model.MySQL_modif.class);
	 ...
	 */
	public MySQL_modif() throws ClassNotFoundException,SQLException {
		this.resultat=true;
	 ...
	 * @throws SQLException Exception liée à une erreur de requête SQL
	 */
	public MySQL_modif(String adresse,String base,String user,String passwd) throws ClassNotFoundException,SQLException {
			Class.forName("com.mysql.jdbc.Driver");
	...
	public String update(String ordre) throws SQLException {
		...
		return("<center><br><br><font color=black size=+2>"+a+" donnée(s) mise(s) à jour</font></center><br>");
	}	
